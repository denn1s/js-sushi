...
const chapter6 = [
  {
    ...
    successMessage: 'Both variables point to the same array in memory — that\'s why both changed! This is called "pass by reference."',
  ...
  },
  {
    ...
    successMessage: 'You can also copy with .slice(): const copy = belt.slice(). Spread is newer and more readable, but both work!',
  ...
  },
  {
    ...
    secondBeltBefore: ['salmon', 'tuna', 'shrimp'],
    secondBeltBeforeLabel: 'lower belt',
    successMessage: 'Heads up: spread makes a "shallow" copy. If the array contains objects, those objects are still shared! For simple values like strings, you\'re safe.',
    secondBeltAfter: ['squid', 'tuna', 'shrimp'],
    secondBeltAfterLabel: 'lower belt',
    secondBeltHighlightIndex: 0,
  },
  {
    ...
    beltAfter: ['salmon', 'tuna', 'shrimp'],
    beltAfterLabel: 'upper belt',
    successMessage: 'This is the non-mutating alternative to .push()! Super useful when you don\'t want to change the original, like in React state updates.',
  ...
  },
  {
    ...
    beltAfterLabel: 'upper belt',
    successMessage: 'You can also merge with .concat(): upperBelt.concat(newDishes). Spread is more flexible — you can add extra items between the arrays!',
